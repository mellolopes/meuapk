...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;

    const-string v1, "shape"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;->shape:Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;
    ...
    invoke-direct {v1, v3, v4}, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;

    const-string v5, "ellipse"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;->ellipse:Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;

    new-instance v5, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;

    const-string v7, "keep"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;->keep:Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;
    ...
    sput-object v7, Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;->$VALUES:[Lcom/opensource/svgaplayer/entities/SVGAVideoShapeEntity$Type;
