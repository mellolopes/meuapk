...
.method static constructor <clinit>()V
    ...
    .line 70
    new-instance v1, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    const-string v3, "VIDEO_CODEC_VP9"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;->VIDEO_CODEC_VP9:Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    .line 71
    new-instance v3, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    const-string v5, "VIDEO_CODEC_H264"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;->VIDEO_CODEC_H264:Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    .line 72
    new-instance v5, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    const-string v7, "VIDEO_CODEC_H265"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;->VIDEO_CODEC_H265:Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;

    const/4 v7, 0x4

    .line 68
    new-array v7, v7, [Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;
    ...
    sput-object v7, Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;->$VALUES:[Lio/agora/rtc/video/MediaCodecVideoEncoder$VideoCodecType;
